...
// Mirrors src/_data/partners.ts in the pnwmoths repo. Kept in sync by hand:
// the two sites share the same institutional partnership, but neither repo
// depends on the other at build time.
